                ...
                <div className='flex w-full h-full relative'>
                    <div className={`w-[280px] h-full absolute z-10 ${show ? '-left-[16px]' : '-left-[320px]'} md:left-0 md:relative transition-all`}>
                        <div className='w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto'>
                            ...
                            <div className='h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-md cursor-pointer bg-[#8288ed]'>
                                ...
                                <div className='flex justify-center items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Jose Arcos</h2>
                                    </div>
                                </div>
                            </div>
                            <div className='h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer'>
                                ...
                                <div className='flex justify-center items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Juan Diaz</h2>
                                    </div>
                                </div>
                            </div>
                            <div className='h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer'>
                                ...
                                <div className='flex justify-center items-start flex-col w-full'>
                                    <div className='flex justify-between items-center w-full'>
                                        <h2 className='text-base font-semibold'>Manuel Ruiz</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        ...
                        <form className='flex gap-3'>
                            <input type="text" className='w-full flex justify-between px-2 border border-slate-700 items-center py-[5px] focus:border-blue-500

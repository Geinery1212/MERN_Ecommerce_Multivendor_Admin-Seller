...
const AdminDashboard = () => {
    ...
    const { loader, totalSales, totalProducts, totalSellers, totalOrders, recentOrders, recentMessages } = useSelector(state => state.dashboard);
    useEffect(() => {
                ...
                <div className='w-full flex flex-wrap mt-7'>
                    ...
                    <div className='w-full lg:w-5/12 lg:pl-4 mt-5 lg:mt-0'>
                        <div className='w-full bg-[#6a5fdf] p-4 rounded-md text-[#d0d2d6]'>
                            <div className='flex justify-between items-center'>
                                ...
                                <Link className='font-semibold text-sm text-[#d0d2d6]' to={'/admin/dashboard/chat-seller'}>View All</Link>
                            </div>
                                        ...
                                        return <li key={i} className='mb-3 ml-6'>
                                            ...
                                            <div className='p-3 bg-slate-800 rounded-lg border border-slate-600 shadow-sm'>
                                                <div className='flex justify-between items-center mb-2'>
                                                    {
                                                        message.senderId === userInfo._id ? message.senderName : <Link className='text-md font-normal' to={`/admin/dashboard/chat-seller/${message.senderId}`}>{message.senderName}</Link>
                                                    }
                    ...
                    <div className='w-full p-4 bg-[#6a5fdf] rounded-md mt-6'>
                        <div className='flex justify-between items-center'>
                            ...
                            <Link className='font-semibold text-sm text-[#d0d2d6]' to={'/admin/dashboard/orders'}>View All</Link>
                        </div>
